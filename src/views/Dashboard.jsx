        ...
        <div className="content">
                  ...
                  <Row>
                    ...
                    <Col sm="6">
                      <ButtonGroup className="btn-group-toggle float-right" data-toggle="buttons">
                        ...
                        >
                          <input name="options" type="radio" />
                          <span className="d-none d-sm-block d-md-block d-lg-block d-xl-block">ANUAL</span>
                          <span className="d-block d-sm-none">
            ...
            <Col lg="3" md="6">
              <Card className="card-stats">
                  ...
                  <Row>
                    <Col xs="5">
                      <div className="info-icon text-center icon-warning">
                        <img src={Scooter} className="icon-cosmicgo" />
                      </div>
                    </Col>
                    <Col xs="7">
                ...
                <CardFooter>
                  <hr />
                  <div className="stats">
                    <i className="tim-icons icon-sound-wave" /> Customers feedback
                  </div>
                </CardFooter>
              </Card>
            </Col>
              ...
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    <Col xs="5">
                      <div className="info-icon text-center icon-warning">
                        <img src={Guy} className="icon-cosmicgo" />
                      </div>
                    </Col>
                    <Col xs="7">
                      <div className="numbers">
              ...
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    <Col xs="5">
                      <div className="info-icon text-center icon-warning">
                        <img src={Active} className="icon-cosmicgo" />
                      </div>
                    </Col>
                    <Col xs="7">
                      <div className="numbers">
                ...
                <CardFooter>
                  <hr />
                  <div className="stats">
                    <i className="tim-icons icon-trophy" /> Update Now
                  </div>
                </CardFooter>
              </Card>
            </Col>
              ...
              <Card className="card-stats">
                <CardBody>
                  <Row>
                    <Col xs="5">
                      <div className="info-icon text-center icon-warning">
                        <img src={Inactive} className="icon-cosmicgo" />
                      </div>
                    </Col>
                    <Col xs="7">
                      <div className="numbers">
                        <p className="card-category">Unavailable Scooters</p>
                        <CardTitle tag="h3">18</CardTitle>
                      </div>
                    </Col>
                  </Row>
                </CardBody>
                <CardFooter>
                  <hr />
                  <div className="stats">
                    <i className="tim-icons icon-watch-time" /> Update Now
                  </div>
                </CardFooter>
              </Card>
            </Col>
          ...
          <Row>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="td-actions text-right">
                            <Button color="link" id="tooltip786630859" title="" type="button">
                        ...
                        <tr>
                          ...
                          <td className="td-actions text-right">
                            <Button color="link" id="tooltip199559448" title="" type="button">
                              <i className="tim-icons icon-pencil" />
                            </Button>
                        ...
                        <tr>
                          ...
                          <td className="td-actions text-right">
                            <Button color="link" id="tooltip989676508" title="" type="button">
                              <i className="tim-icons icon-pencil" />
                            </Button>
                        ...
                        <tr>
                          ...
                          <td className="td-actions text-right">
                            <Button color="link" id="tooltip557118868" title="" type="button">
                              <i className="tim-icons icon-pencil" />
                            </Button>
                        ...
                        <tr>
                          ...
                          <td className="td-actions text-right">
                            <Button color="link" id="tooltip143185858" title="" type="button">
                              <i className="tim-icons icon-pencil" />
                            </Button>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip216846074">
                            Tooltip on top
                          </UncontrolledTooltip>
                          <Button
                            className="btn-link btn-icon btn-neutral"
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip391990405">
                            Tooltip on top
                          </UncontrolledTooltip>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="text-right">
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip191500186">
                            Tooltip on top
                          </UncontrolledTooltip>
                          <Button
                            className="btn-link btn-icon btn-neutral"
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip320351170">
                            Tooltip on top
                          </UncontrolledTooltip>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="text-right">
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip345411997">
                            Tooltip on top
                          </UncontrolledTooltip>
                          <Button
                            className="btn-link btn-icon"
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip601343171">
                            Tooltip on top
                          </UncontrolledTooltip>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="text-right">
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip774891382">
                            Tooltip on top
                          </UncontrolledTooltip>
                          <Button
                            className="btn-link btn-icon"
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip949929353">
                            Tooltip on top
                          </UncontrolledTooltip>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="text-right">
                          ...
                          <UncontrolledTooltip delay={0} target="tooltip156899243">
                            Tooltip on top
                          </UncontrolledTooltip>
                        </td>
                      </tr>
            ...
            <Col lg="12">
              <Card>
                <CardHeader>
                  <CardTitle tag="h4">Global Daily Statistics by Locations</CardTitle>
                      ...
                      <Table responsive>
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div className="flag">
                                <img alt="..." src={require('assets/img/US.png')} />
                              </div>
                            </td>
                            <td>USA</td>
                          ...
                          <tr>
                            <td>
                              <div className="flag">
                                <img alt="..." src={require('assets/img/DE.png')} />
                              </div>
                            </td>
                            <td>Germany</td>
                          ...
                          <tr>
                            <td>
                              <div className="flag">
                                <img alt="..." src={require('assets/img/AU.png')} />
                              </div>
                            </td>
                            <td>Australia</td>
                          ...
                          <tr>
                            <td>
                              <div className="flag">
                                <img alt="..." src={require('assets/img/GB.png')} />
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div className="flag">
                                <img alt="..." src={require('assets/img/RO.png')} />
                              </div>
                            </td>
                            <td>Romania</td>
                          ...
                          <tr>
                            <td>
                              <div className="flag">
                                <img alt="..." src={require('assets/img/BR.png')} />
                              </div>
                            </td>
                            <td>Brasil</td>
